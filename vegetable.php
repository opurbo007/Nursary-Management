...
if(isset($_POST['src'])){
    ...
    $sql="SELECT * FROM `vegetable` WHERE name LIKE '%{$src}%'";
    ...
    ?>
                 <form class="d-flex" method="POST" action="">
                     <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" name="src"
                         value="<?php echo $src;?>">
...
?>
                 ...
                 <tr>
                     ...
                     <td class="action">
                         <a href="lib/updateForm.php?id=<?php echo $row["id"];?>">
                         ...
                         <a href="lib/delete.php?id=<?php echo $row["id"];?>"><span class="deleteIcon icon">
